...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DWvdkIO3.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DioQ2GDM.mjs").then((n) => n.t),
		import("./start-Bty2oj9k.mjs"),
...
async function getServerEntry() {
	return server_default$1 ?? server_exports;
}
...
//#endregion
export { ssr_exports as a, renderErrorPage as i, createCsrfMiddleware as n, createMiddleware as r, __exportAll as t };
